...
/*  Created On : 09-май-2021 22:42:38 				*/
/*  DBMS       : MySql 						*/
/* ---------------------------------------------------- */
...
ALTER TABLE `content_movies_urls` 
 ADD INDEX `IXFK_content_movies_urls_content_movies` (`ct_id` ASC, `c_id` ASC)
;
...
ALTER TABLE `content_series_url` 
 ADD INDEX `IXFK_content_url_resolutions` (`r_id` ASC)
;
...
ALTER TABLE `content_movies_urls` 
 ADD CONSTRAINT `FK_content_movies_urls_content_movies`
	FOREIGN KEY (`ct_id`, `c_id`) REFERENCES `content_movies` (`ct_id`,`c_id`) ON DELETE Cascade ON UPDATE Cascade
;
...
ALTER TABLE `content_series_seasons` 
 ADD CONSTRAINT `FK_content_series_seasons_content_series`
	FOREIGN KEY (`ct_id`, `c_id`) REFERENCES `content_series` (`ct_id`,`c_id`) ON DELETE Cascade ON UPDATE Cascade
;
...
ALTER TABLE `content_series_url` 
 ADD CONSTRAINT `FK_content_url_resolutions`
	FOREIGN KEY (`r_id`) REFERENCES `resolutions` (`r_id`) ON DELETE Cascade ON UPDATE Cascade
;
