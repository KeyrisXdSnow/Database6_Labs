...
/*  Created On : 19-апр.-2021 19:09:09 				*/
/*  DBMS       : MySql 						*/
/* ---------------------------------------------------- */
...
(
	...
	`ct_id` INT NULL,
	`c_id` BIGINT NULL,
	CONSTRAINT `PK_ratings` PRIMARY KEY (`r_id` ASC)
)
...
(
	...
	CONSTRAINT `PK_users_m2m_user_cards` PRIMARY KEY (`uc_number` ASC, `u_id` ASC)
)
...
ALTER TABLE `profiles` 
 ADD INDEX `users_id_profiles_is_active` (`u_id` ASC, `profiles_is_active` ASC)
;

ALTER TABLE `ratings` 
 ADD INDEX `IXFK_ratings_content` (`ct_id` ASC, `c_id` ASC)
;

ALTER TABLE `ratings` 
 ADD INDEX `ratings_value` (`r_value` ASC)
;
...
ALTER TABLE `user` 
 ADD INDEX `users_email_users_password` (`u_email` ASC, `u_password` ASC)
;

ALTER TABLE `user` 
 ADD INDEX `users_last_payment_date_user_is_auto_paymeny` (`u_last_payment_date` ASC, `u_is_auto_payment` ASC)
;
...
ALTER TABLE `users_m2m_user_cards` 
 ADD INDEX `user_cards_id_users_m2m_user_cards_active` (`u_id` ASC, `umuc_card_is_active` ASC)
;
